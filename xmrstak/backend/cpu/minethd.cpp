...
bool minethd::self_test()
{
	...
	else if(::jconf::inst()->GetCurrentCoinSelection().GetDescription(1).GetMiningAlgo() == cryptonight_mox)
	{
	}
...
minethd::cn_hash_fun minethd::func_selector(bool bHaveAes, bool bNoPrefetch, xmrstak_algo algo)
{
	...
	static const cn_hash_fun func_table[] = {
		...
		cryptonight_hash<cryptonight_mox, false, false>,
		cryptonight_hash<cryptonight_mox, true, false>,
		cryptonight_hash<cryptonight_mox, false, true>,
		cryptonight_hash<cryptonight_mox, true, true>,
...
minethd::cn_hash_fun_multi minethd::func_multi_selector(size_t N, bool bHaveAes, bool bNoPrefetch, xmrstak_algo algo)
{
	...
	static const cn_hash_fun_multi func_table[] = {
		...
		cryptonight_double_hash<cryptonight_mox, false, false>,
		cryptonight_double_hash<cryptonight_mox, true, false>,
		cryptonight_double_hash<cryptonight_mox, false, true>,
		cryptonight_double_hash<cryptonight_mox, true, true>,
		cryptonight_triple_hash<cryptonight_mox, false, false>,
		cryptonight_triple_hash<cryptonight_mox, true, false>,
		cryptonight_triple_hash<cryptonight_mox, false, true>,
		cryptonight_triple_hash<cryptonight_mox, true, true>,
		cryptonight_quad_hash<cryptonight_mox, false, false>,
		cryptonight_quad_hash<cryptonight_mox, true, false>,
		cryptonight_quad_hash<cryptonight_mox, false, true>,
		cryptonight_quad_hash<cryptonight_mox, true, true>,
		cryptonight_penta_hash<cryptonight_mox, false, false>,
		cryptonight_penta_hash<cryptonight_mox, true, false>,
		cryptonight_penta_hash<cryptonight_mox, false, true>,
		cryptonight_penta_hash<cryptonight_mox, true, true>,
