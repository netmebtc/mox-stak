...
enum xmrstak_algo
{
	...
	cryptonight_mox = 7, //equal to cryptonight_monero but with one tiny change
	...
	cryptonight_bittube2 = 10, // derived from cryptonight_heavy with own aes-round implementation and minor other tweaksabc
};
...
constexpr size_t CRYPTONIGHT_MEMORY = 1 * 1024 * 1024;
constexpr uint32_t CRYPTONIGHT_MASK = 0xFFFF0;
constexpr uint32_t CRYPTONIGHT_ITER = 0x40000;
...
template<>
inline constexpr size_t cn_select_memory<cryptonight_mox>() { return CRYPTONIGHT_MEMORY; }
...
template<>
inline constexpr uint32_t cn_select_mask<cryptonight_mox>() { return CRYPTONIGHT_MASK; }
...
template<>
inline constexpr uint32_t cn_select_iter<cryptonight_mox>() { return CRYPTONIGHT_ITER; }
